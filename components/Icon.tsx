...
interface IconProps {
    name: 'copy' | 'check' | 'sparkles' | 'loader' | 'logo';
    className?: string;
}
...
export const Icon: React.FC<IconProps> = ({ name, className = 'w-6 h-6' }) => {
    const icons: Record<typeof name, React.ReactNode> = {
        ...
        loader: (
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.667 0l3.181-3.183m-4.991-2.696V7.985h-4.992a4.5 4.5 0 00-4.5 4.5v4.507" />
            </svg>
        ),
        logo: (
